                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Registrasi</h1>
                            </div>
                            <form action="{{ route('register') }}" method="POST" class="mt-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nama Lengakap" name="fullname" id="fullname" autofocus required>
                                        @error('fullname')
                                ...
                                {{-- <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nim" class="form-control" placeholder="Nomor Induk Mahasiswa" id="nim" autofocus required>
                                    </div>  
                                </div> --}}
                                <!-- End of Form -->
