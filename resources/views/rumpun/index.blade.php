...
@section('judul', 'Manajemen Rumpun')
@section('content')
@php
$base = 'rumpun'
@endphp
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/'.$base.'/store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-2">
                            <label for="" class="lable">Nama Rumpun</label>
                            <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required class="form-control">
                        </div>
                        <div class="mb-2">
                            <label for="" class="lable">Singkatan</label>
                            <input type="text" name="singkatan" id="singkatan" value="{{ old('singkatan') }}" required id="" class="form-control">
                        </div>
