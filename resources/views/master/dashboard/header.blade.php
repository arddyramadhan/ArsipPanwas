    ...
    <div class="container-xl">
        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="d-none d-md-flex mx-2">
                <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="Aktivkan Mode Malam" data-bs-toggle="tooltip" data-bs-placement="bottom">
                    <!-- Download SVG icon from http://tabler-icons.io/i/moon -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
                </a>
                <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="Aktivkan Mode Siang" data-bs-toggle="tooltip" data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    ...
                    <span class="avatar avatar-sm" style="background-image: url({{ Auth::user()->foto != null ? asset('./storage/'.Auth::user()->foto) : asset('./static/admin.png') }})"></span>
                    @else
                    <span class="avatar avatar-sm" style="background-image: url({{ Auth::user()->foto != null ? asset(Auth::user()->foto) : asset('./static/biro.png') }})"></span>
                    @endif
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#ubah_akun" class="dropdown-item">Profile & account</a>
