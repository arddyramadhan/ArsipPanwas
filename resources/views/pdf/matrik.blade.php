...
<body>
    <center>
        <h1> MATRIK MATA KULIAH JURUSAN PENDIDIKAN BAHASA DAN SASTRA INDONESIA
            <br> KURIKULUM
    ...
    <table width="100%" style="border: 2px solid black">
        <tr style="background-color: lightsteelblue">
            <th class="all" valign="center" rowspan="2">No</th>
            <th class="all" valign="center" rowspan="2">Matakuliah</th>
