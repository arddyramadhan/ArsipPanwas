...
<div>
    ...
    {{-- ! Edit --}}
    <div class="modal fade" id="edit{{ $fakultas->id }}" tabindex="-1" role="dialog" aria-labelledby="modalTitleNotify" aria-hidden="true">
                ...
                <form action="{{ url('./fakultas/'.$fakultas->id.'/update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group py-2">
                            ...
                            <textarea name="alamat" id="" class="form-control" cols="30" rows="10">{{ $fakultas->alamat }}</textarea>
                        </div>
                        <div class="form-group py-2">
