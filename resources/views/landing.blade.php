    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mb-lg-6">
            <div class="col-12 text-center">
                ...
                <p class="lead px-lg-10">Every page from Volt has been carefully built to provide all the necessary
                    pages your startup will require</p>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-6 mb-5">
                <a href="./pages/dashboard/dashboard.html" class="page-preview scale-up-2">
                    <img class="shadow-lg rounded scale" src="./assets/img/pages/overview.jpg"
                        alt="Dashboard page preview">
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Overview <svg
            ...
            <div class="col-6 mb-5">
                <a href="./pages/transactions.html" class="page-preview scale-up-2">
                    <img class="shadow-lg rounded scale" src="./assets/img/pages/transactions.jpg"
                        alt="Transactions page preview">
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Transactions <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/settings.html" class="page-preview scale-up-2">
                    <img class="shadow-lg rounded scale" src="./assets/img/pages/settings.jpg"
                        alt="Settings page preview">
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Settings <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/examples/sign-in.html" class="page-preview scale-up-2">
                    <img class="shadow-lg rounded scale" src="./assets/img/pages/sign-in.jpg"
                        alt="Sign In page preview">
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Sign In <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/examples/sign-up.html" class="page-preview scale-up-2">
                    <img class="shadow-lg rounded scale" src="./assets/img/pages/sign-up.jpg"
                        alt="Sign Up page preview">
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Sign Up <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/examples/lock.html" class="page-preview scale-up-2">
                    ...
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Lock <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/examples/forgot-password.html" class="page-preview scale-up-2">
                    <img class="shadow-lg rounded scale" src="./assets/img/pages/forgot-password.jpg"
                        alt="Forgot password preview">
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Forgot password <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/examples/reset-password.html" class="page-preview scale-up-2">
                    <img class="shadow-lg rounded scale" src="./assets/img/pages/reset-password.jpg"
                        alt="Reset password preview">
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">Reset password <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/examples/404.html" class="page-preview scale-up-2">
                    ...
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">404 <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
            ...
            <div class="col-6 mb-5">
                <a href="./pages/examples/500.html" class="page-preview scale-up-2">
                    ...
                    <div class="text-center show-on-hover rounded-bottom">
                        <h6 class="m-0 text-center d-inline-flex align-items-center text-white">500 <svg
                                class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mb-lg-6">
            <div class="col-12 text-center">
                ...
                <p class="lead px-lg-8">You get all Bootstrap components fully customized. Besides, you receive numerous
                ...
                <div class="card bg-white shadow-soft text-primary rounded mb-4">
                    <div class="px-3 px-lg-4 py-5 text-center">
                        <svg class="icon icon-md mb-3" aria-hidden="true" focusable="false" data-prefix="fab"
                            data-icon="bootstrap" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            <path fill="currentColor"
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 mb-lg-6">
            <div class="col-12 text-center">
                ...
                <p class="lead px-lg-8">We have carefully crafted the perfect folder structure to ensure that finding
                    the files you're looking for are easily reachable and well organized.</p>
            </div>
        </div>
        <div class="row d-flex align-items-center">
            ...
            <div class="col-12 col-lg-6 order-lg-first d-flex justify-content-center">
                <ul class="d-block fmw-100 list-unstyled folder-structure">
                    ...
                    <li>
                        <ul class="list-unstyled ps-4">
                            ...
                            <li class="d-flex align-items-center mb-1" data-bs-toggle="tooltip" data-bs-placement="left"
                                ...
                                <svg class="icon icon-sm me-2 text-warning" aria-hidden="true" focusable="false"
                    ...
                    <li class="d-flex align-items-center mb-1" data-bs-toggle="tooltip" data-bs-placement="left"
                        title="Rocket with only HTML, CSS and Javascript">
                        <svg class="icon icon-sm me-2" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M2 6a2 2 0 012-2h5l2 2h5a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6z"></path>
                        </svg>
                    ...
                    <li class="d-flex align-items-center mb-1" data-bs-toggle="tooltip" data-bs-placement="left"
                        ...
                        <svg class="icon icon-sm me-2 text-warning" aria-hidden="true" focusable="false"
                            data-prefix="fab" data-icon="js-square" class="svg-inline--fa fa-js-square fa-w-14"
                    ...
                    <li class="d-flex align-items-center mb-1" data-bs-toggle="tooltip" data-bs-placement="left"
                        ...
                        <svg class="icon icon-sm me-2 text-success" aria-hidden="true" focusable="false"
                            data-prefix="fas" data-icon="file-code" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 384 512">
                            <path fill="currentColor"
            ...
            <div class="col-12 mt-5 d-lg-none">
                ...
                <p>Don't worry, we got you covered. We have a folder called <code class="text-danger">html&css</code>
                    which includes only the basic HTML5, CSS3 and Javascript technologies.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center text-center text-white mb-5">
            <div class="col-12">
                ...
                <p class="lead px-lg-8">
                    Boost productivity with BrowserSync. Sass changes are reflected instantly and pages scroll and
        ...
        <div class="row justify-content-center mb-6">
            <div class="col-md-10 col-xl-9">
                ...
                <p class="mt-4 text-white text-center">Looks unfamiliar? Don’t worry! Our <a
                        ...
                        target="_blank">documentation</a> has got you covered.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-8">
                ...
                <p class="lead mb-4">Volt is an open source project under the MIT License. Give us a lucky star to
                    spread the open source love ❤️</p>
                <div class="d-flex align-items-center">
                    <a href="https://github.com/themesberg/volt-bootstrap-5-dashboard" target="_blank"
                ...
                <div class="card shadow border-0 p-4">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush price-list">
                            ...
                            <li class="list-group-item d-flex align-items-center border-0 ps-0"><svg
                                    class="icon icon-xs text-danger me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                                        clip-rule="evenodd"></path>
                                </svg> Advanced sidebar</li>
                            <li class="list-group-item d-flex align-items-center border-0 ps-0"><svg
                                    class="icon icon-xs text-danger me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                            ...
                            <li class="list-group-item d-flex align-items-center border-0 ps-0 pb-0"><svg
                                    class="icon icon-xs text-danger me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z"
                ...
                <div class="card shadow border-0 p-4 py-5 mt-lg-n5">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush price-list">
                            ...
                            <li class="list-group-item d-flex align-items-center border-0 ps-0"><svg
                                    class="icon icon-xs text-success me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                            ...
                            <li class="list-group-item d-flex align-items-center border-0 border-0 ps-0 pb-0"><svg
                                    class="icon icon-xs text-success me-2" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                                        d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                    ...
                    <a href="https://demo.themesberg.com/volt-pro/index.html" target="_blank"
                        class="btn btn-secondary d-flex align-items-center justify-content-center mb-0 mt-2">Demo Volt
                        Pro <svg class="icon icon-xs ms-1" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z">
                            </path>
        ...
        <div class="mt-lg-6 row">
            <div class="text-center col-12">
                ...
                <div>
                    ...
                    <a class="me-3 card-link" href="https://demo.themesberg.com/volt-react-dashboard/#/"
                        target="_blank">
